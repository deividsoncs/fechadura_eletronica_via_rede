...
char SELECT_RG[100] = "SELECT id, nome, senha, rg FROM arduino_db.usuarios WHERE(rg like '%s');";
...
void loop() {
            ...
            if (row != NULL) {
              ...
              if (senhaBco != NULL) {
                ...
                if (strcmp(senha, senhaDig)) {
                  ...
                  sprintf(QUERY_AUX, INSERT_HISTORICO, PORTA_ATUACAO, idUsuario);
  ...
  if (keyPress == '#') {
    ...
    do {
      ...
      if (millis() - millisAnteriorRG > tempoLeituraSenha) {
        break;
      } else {
        keyRG = keypad.getKey();
        if (keyRG == '#' || keyRG == '*') {
        ...
        if (keyRG != NO_KEY && keyRG != '#' && keyRG != '*') {
          ...
          rg[tamRG] = keyRG;
          tamRG++;
          if (keyRG == '0' || keyRG == '1' || keyRG == '2' || keyRG == '3' || keyRG == '4' ||
              keyRG == '5' || keyRG == '6' || keyRG == '7' || keyRG == '8' || keyRG == '9'){
            strRG.concat(keyRG);
          }
        }
